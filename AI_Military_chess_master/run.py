...
class HumanInputWrapper:
    ...
    def __init__(self, role, ui, game):
        self.role = role
        self.ui = ui
        self.game = game
        self.status = "WAIT"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--init_board", dest="init_ncn",
                        ...
                        default="lpdfd/aggdy/v1t1g/ty1pj/z1s1z/spllv/5/AYVGJ/Y1P1Z/SL1GT/V1P1Z/LGTDS/LPDFD")
